...
\normalsize{
In questo primo capitolo verrà analizzato il problema al livello di
astrazione più alto.\\
E' stata richiesta la progettazione di una base di dati relazionale
per un software di recensioni turistiche, quindi il focus del problema
è stato quello di permettere agli utenti della piattaforma la possibilità
di recensire così come poter pubblicare una propria attività. Da come è
possibile analizzare dal {\it class diagram} a pagina successiva
il perno del software presentato è il concetto di {\bf Business }, al quale
è permesso a uno o più utenti di associarvi una recensione, accompagnata, o
meno, da immagini e descrizione.
}
...
\normalsize{
*Durante lo sviluppo del progetto non è stato necessario alcun
class diagran {\it non} ristrutturato, ergo, questo è stato l'
 unico utilizzato.
}
...
\\~\\~\\
{\bf 4.1 Note sull'implementazione}
\\
\normalsize{
Alcuni dettagli implementativi saranno modificati al fine di sfruttare molte delle comodità
offerte dal DBMS in questione. Inoltre ,alcune funzionalità verranno 'camuffate' come la
funzione \verb|INSTR| presente su \verb|ORACLE|, non disponibile invece su \verb|PostgreSQL|,
così come l'implementazione di \verb|ASSERTION|, anch'esse rimpiazzate da procedure poichè
non disponibili.\\
}
\end{flushleft}
\newpage
...
\vspace{-2cm}
\begin{flushleft}
{\bf 4.2 Definizione delle tabelle} 
\\
Seguono le definizioni delle tabelle estratte dallo script di creazione del database.\\
{\it *Alcune parole saranno grammaticalmente sbagliate poichè alcuni 
caratteri speciali risultano incompatibili col DBMS.}
\vspace*{+1cm}

{\bf 4.2.1  Definizione della tabella UTENTE}
...
{\bf 4.2.2  Definizione della tabella MAPPA}
\begin{lstlisting}[language=SQL]
/**
*	  TABELLA: MAPPA
*   Crea la tabella e implementa i vincoli piu semplici
...
\vspace{-2cm}
\begin{flushleft}
{\bf 4.2.3  Definizione della tabella BUSINESS}
\begin{lstlisting}[language=SQL]
/**
*	  TABELLA: BUSINESS
*   Crea la tabella e implementa i vincoli piu semplici
...
{\bf 4.2.4  Definizione della tabella RECENSIONE}
\begin{lstlisting}[language=SQL]
/**
*	  TABELLA: RECENSIONE
*   Crea la tabella e implementa i vincoli piu semplici
...
\vspace{-2cm}
\begin{flushleft}
{\bf 4.2.5  Definizione della tabella ASSOCIAZIONERAFFINAZIONE}
\begin{lstlisting}[language=SQL]
/**
...
{\bf 4.2.6  Definizione della tabella IMMAGINEPROPRIETA}
\begin{lstlisting}[language=SQL]
/**
...
{\bf 4.2.7  Definizione della tabella IMMAGINERECENSIONE}
\begin{lstlisting}[language=SQL]
/**
...
\vspace{-2cm}
\begin{flushleft}
{\bf 4.3 Funzioni, procedure e altre automazioni} 
\vspace*{+1cm}
\\
...
{\bf 4.3.2  Integrità delle raffinazioni per tipologia 'Alloggio'}\\
...
{\bf 4.3.3 Integrità delle raffinazioni per tipologia 'Attrazione'}\\
...
\vspace{-2cm}
\begin{flushleft}
{\bf 4.3.4  Generazione codice verifica per Utente}\\
...
{\bf 4.3.6  Effettua la registrazione}\\
...
\newpage\null\pagenumbering{arabic}\setcounter{page}{19}
\vspace{-2cm}
\begin{flushleft}
{\bf 4.3.7  Imposta nuova password}\\
...
{\bf 4.3.8  Controlla documenti utente}\\
...
{\bf 4.3.9  Controlla codice verifica}\\
...
\vspace{-2cm}
\begin{flushleft}
{\bf 4.3.10  Inserisci documenti utente}\\
...
{\bf 4.3.11  Inserisci business}\\
Tale procedura inserisce o aggiorna un business. Se la \verb|PartitaIVA| risulta già presente
nel database e l'utente che tenta di reinserirla è il proprietario del business, allora
questo verrà aggiornato, altrimenti verrà inserito ex novo.
\begin{lstlisting}[language=SQL]
...
{\bf 4.3.12  Inserisci immagini a business}\\
...
\vspace{-2cm}
\begin{flushleft}
{\bf 4.3.13  Recupera codBusiness}\\
...
{\bf 4.3.14  Inserisci raffinazioni}\\
...
{\bf 4.3.16  Inserisci immagine recensione}\\
...
\vspace{-2cm}
\begin{flushleft}
{\bf 4.3.17  Inserisci recensione}\\
...
\vspace{-2cm}
\begin{flushleft}
{\bf 4.3.19  Aggiorna media stelle}\\
...
{\bf 4.3.20  Utente con recensione}\\
