...
public class PubblicaBusiness1 extends JPanel {
	...
	private frameGUI.pannelliSchermataPrincipale.raffinazioni.pannelloRaffinazioniRistorante pannelloRaffRistorante;
	private frameGUI.pannelliSchermataPrincipale.raffinazioni.pannelloRaffinazioneAlloggi pannelloRaffAlloggi;
	private frameGUI.pannelliSchermataPrincipale.raffinazioni.pannelloRaffinazioneAttrazioni pannelloRaffAttrazioni;
	...
	private void generaRaffinazioniAttrazione() {
		pannelloRaffAttrazioni = new frameGUI.pannelliSchermataPrincipale.raffinazioni.pannelloRaffinazioneAttrazioni();
	...
	private void generaRaffinazioniAlloggio() {
		pannelloRaffAlloggi = new frameGUI.pannelliSchermataPrincipale.raffinazioni.pannelloRaffinazioneAlloggi();
	...
	private void generaPannelloRaffRistorante() {
		pannelloRaffRistorante = new frameGUI.pannelliSchermataPrincipale.raffinazioni.pannelloRaffinazioniRistorante();
